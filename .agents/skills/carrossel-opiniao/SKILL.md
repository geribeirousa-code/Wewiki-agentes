---
name: carrossel-opiniao
description: Gera carrossel estilo thread X/Twitter (Instagram). Slides com foto de perfil, nome, badge verificado, handle e texto do tweet. Suporta imagens embutidas, tema claro/escuro, combinar tweets curtos num slide. Lufga Bold 62px quando usado com o template carrossel-opiniao. Use quando pedir carrossel de opinião, thread carrossel, carrossel com dado surpresa, ou carrossel estilo X/Twitter.
---
